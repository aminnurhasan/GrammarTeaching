...
@section('title', __('user.pretest_survey_title'))

@section('content')
<div class="container my-4">
    <div class="card shadow-sm p-4">
        <h1 class="card-title fw-bold text-center mb-4">@lang('user.survey_pretest_title')</h1>
        <p class="text-center">@lang('user.survey_pretest_description')</p>
        <form action="{{ route('kuis.pretest.store') }}" method="POST">
            @csrf
            ...
            <div class="d-grid gap-2 mt-4">
                <button type="submit" class="btn btn-primary btn-lg">@lang('user.continue_to_quiz')</button>
            </div>
        </form>
    </div>
</div>
