...
@section('title', __('user.password_change'))
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.password.update') }}">
                        ...
                        <div class="mb-3">
                            <label for="password_confirmation" class="form-label">{{ __('user.confirm_new_password') }}</label>
                        ...
                        <button type="submit" class="btn btn-primary">{{ __('user.update_password') }}</button>
                    </form>
                </div>
            </div>
        </div>
