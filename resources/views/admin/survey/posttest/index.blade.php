...
@section('title', __('admin.survey_posttest'))

@section('content')
<div class="container py-5">
    <h1 class="mb-4">{{ __('admin.survey_posttest') }}</h1>
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('admin.survey.posttest.create') }}" class="btn btn-primary">{{ __('admin.tambah_survey_posttest') }}</a>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('admin.survey.posttest.show', $survey->id) }}" class="btn btn-sm btn-info" title="{{ __('admin.lihat') }}">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.survey.posttest.edit', $survey->id) }}" class="btn btn-sm btn-warning" title="{{ __('admin.ubah') }}">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <form action="{{ route('admin.survey.posttest.destroy', $survey->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
