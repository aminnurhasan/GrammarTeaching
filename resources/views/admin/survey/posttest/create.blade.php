...
@section('title', __('admin.tambah_survey_posttest'))

@section('content')
<div class="container py-5">
    <h1 class="mb-4">{{ __('admin.tambah_survey_posttest') }}</h1>
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.survey.posttest.store') }}" method="POST">
                @csrf
